...
const versionRefs = html.match(/\?v=1\.25\.37/g) || [];
assert.strictEqual(versionRefs.length, 6, 'All CSS/JS cache-busting references must use v1.25.37');
assert.match(html, /Thai Trainer[^<]*v1\.25\.37/, 'Visible version label must use v1.25.37');

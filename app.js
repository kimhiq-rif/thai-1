...
const WORDS = [
  ...
  {id:"uv19_0084",level:3,thai:"ทุกคน",roman:"tuk-kon",hebrew:"כולם",english:"everyone",tone:'not_drilled',source:"תומר 3,csv.txt"},
  {id:"uv19_0085",level:3,thai:"อย่ารอ",roman:"yaa ror",hebrew:"אל תחכה",english:"do not wait",tone:'not_drilled',source:"תומר 3,csv.txt"},
  {id:"uv19_0086",level:5,thai:"พอไหม",roman:"phaw mai?",hebrew:"זה מספיק?",english:"Is it enough?",tone:'not_drilled',source:"תומר 3,csv.txt"},
  {id:"uv19_0087",level:5,thai:"ไปไหน",roman:"bpai nai?",hebrew:"לאן אתה הולך?",english:"Where are you going?",tone:'not_drilled',source:"תומר 3,csv.txt"},
  {id:"uv19_0088",level:3,thai:"ทบทวน",roman:"tobp-tuan",hebrew:"לחזור (על חומר)",english:"review",tone:'not_drilled',source:"תומר 3,csv.txt"},
  {id:"uv19_0089",level:1,thai:"พี่",roman:"pii",hebrew:"אח/אחות מבוגר/ת",english:"older sibling / senior",tone:'not_drilled',source:"תומר 3,csv.txt"},
  {id:"uv19_0090",level:1,thai:"ลืม",roman:"leuum",hebrew:"לשכוח",english:"forget",tone:'not_drilled',source:"תומר 3,csv.txt"},
  {id:"uv19_0091",level:1,thai:"และ",roman:"laeh",hebrew:"ו...",english:"and",tone:'not_drilled',source:"תומר 3,csv.txt"},
  {id:"uv19_0092",level:5,thai:"คุณพูดภาษาอะไร",roman:"kun puud paasaa a-rai?",hebrew:"איזו שפה אתה מדבר?",english:"What language do you speak?",tone:'not_drilled',source:"תומר 3,csv.txt"},
  {id:"uv19_0093",level:1,thai:"เสร็จ",roman:"sed",hebrew:"לסיים",english:"finish / done",tone:'not_drilled',source:"תומר 3,csv.txt"},
  {id:"uv19_0094",level:1,thai:"เย็น",roman:"yen",hebrew:"קר",english:"cold / evening",tone:'not_drilled',source:"תומר 3,csv.txt"},
  {id:"uv19_0095",level:5,thai:"คุณมาจาก…",roman:"kun maa jaag (place)",hebrew:"מאיפה אתה?",english:"Where are you from?",tone:'not_drilled',source:"תומר 3,csv.txt"},
  {id:"uv19_0096",level:1,thai:"จาก",roman:"jaag",hebrew:"מ... (מקור)",english:"from",tone:'not_drilled',source:"תומר 3,csv.txt"},
  {id:"uv19_0097",level:4,thai:"ไหน/ที่ไหน",roman:"nai/tii nai",hebrew:"איפה",english:"where",tone:'not_drilled',source:"תומר 3,csv.txt"},
  {id:"uv19_0098",level:3,thai:"ห้องครัว",roman:"hong krua",hebrew:"מטבח",english:"kitchen",tone:'not_drilled',source:"תומר 3,csv.txt"},
  {id:"uv19_0099",level:1,thai:"ใจ",roman:"jaai",hebrew:"לב",english:"heart / mind",tone:'not_drilled',source:"תומר 3,csv.txt"},
  {id:"uv19_0100",level:3,thai:"ใจดี",roman:"jaai dii",hebrew:"לב טוב",english:"kind",tone:'not_drilled',source:"תומר 3,csv.txt"},
  {id:"uv19_0101",level:5,thai:"ทำไม",roman:"tam-mai?",hebrew:"למה?",english:"why?",tone:'not_drilled',source:"תומר 3,csv.txt"},
  {id:"uv19_0102",level:1,thai:"มาก",roman:"maag",hebrew:"מאוד",english:"very / much",tone:'not_drilled',source:"תומר 3,csv.txt"},
  {id:"uv19_0103",level:1,thai:"สอน",roman:"sawn",hebrew:"ללמד",english:"teach",tone:'not_drilled',source:"תומר 3,csv.txt"},
  {id:"uv19_0104",level:1,thai:"แพง",roman:"peang",hebrew:"יקר",english:"expensive",tone:'not_drilled',source:"תומר 3,csv.txt"},
  {id:"uv19_0105",level:3,thai:"ทุกอย่าง",roman:"tug-yaang",hebrew:"הכל",english:"everything",tone:'not_drilled',source:"תומר 3,csv.txt"},
  {id:"uv19_0106",level:1,thai:"แต่",roman:"dtae",hebrew:"אבל",english:"but",tone:'not_drilled',source:"תומר 3,csv.txt"},
  {id:"uv19_0107",level:1,thai:"ตก",roman:"tok",hebrew:"ליפול",english:"fall",tone:'not_drilled',source:"תומר 3,csv.txt"},
  {id:"uv19_0108",level:3,thai:"น้ำตก",roman:"nam-tok",hebrew:"מפל",english:"waterfall",tone:'not_drilled',source:"תומר 3,csv.txt"},
  {id:"uv19_0109",level:1,thai:"คิด",roman:"kid",hebrew:"לחשוב",english:"think",tone:'not_drilled',source:"תומר 3,csv.txt"},
  {id:"uv19_0110",level:5,thai:"คุณคิดอะไร",roman:"kun kid a-rai?",hebrew:"על מה אתה חושב?",english:"What are you thinking?",tone:'not_drilled',source:"תומר 3,csv.txt"},
  ...
  {id:"uv19_0118",level:3,thai:"เท่ากับ",roman:"ta-gab",hebrew:"שווה",english:"equals",tone:'not_drilled',source:"תומר 3,csv.txt"},
  {id:"uv19_0119",level:3,thai:"เท่า",roman:"tao",hebrew:"שווה / באותה מידה",english:"equal / as much as",tone:'not_drilled',source:"תומר 3,csv.txt"},
  {id:"uv19_0120",level:3,thai:"เท่าไร",roman:"tao-rai",hebrew:"כמה (מחיר)",english:"how much?",tone:'not_drilled',source:"תומר 3,csv.txt"},
  {id:"uv19_0121",level:4,thai:"แล้วแต่คุณ",roman:"laew-dtua kun",hebrew:"תלוי בך",english:"up to you",tone:'not_drilled',source:"תומר4,csv.txt"},
  {id:"uv19_0122",level:5,thai:"กี่โมง",roman:"gii mong?",hebrew:"איזו שעה?",english:"what time?",tone:'not_drilled',source:"תומר4,csv.txt"},
  {id:"uv19_0123",level:3,thai:"ตอนนี้",roman:"dtua-ni",hebrew:"עכשיו",english:"now",tone:'not_drilled',source:"תומר4,csv.txt"},
  {id:"uv19_0124",level:3,thai:"วันนี้",roman:"wan-nii",hebrew:"היום",english:"today",tone:'not_drilled',source:"תומר4,csv.txt"},
  {id:"uv19_0125",level:3,thai:"พรุ่งนี้",roman:"pru-ngii",hebrew:"מחר",english:"tomorrow",tone:'not_drilled',source:"תומר4,csv.txt"},
  {id:"uv19_0126",level:3,thai:"เมื่อวาน",roman:"meua-wan",hebrew:"אתמול",english:"yesterday",tone:'not_drilled',source:"תומר4,csv.txt"},
  {id:"uv19_0127",level:3,thai:"ตอนเช้า",roman:"dtan-chao",hebrew:"בוקר",english:"morning",tone:'not_drilled',source:"תומר4,csv.txt"},
  {id:"uv19_0128",level:3,thai:"ตอนเที่ยง",roman:"dtan-tiang",hebrew:"צהריים",english:"noon",tone:'not_drilled',source:"תומר4,csv.txt"},
  {id:"uv19_0129",level:3,thai:"ตอนเย็น",roman:"dtan-yen",hebrew:"ערב",english:"evening",tone:'not_drilled',source:"תומר4,csv.txt"},
  {id:"uv19_0130",level:4,thai:"ตอนกลางคืน",roman:"dtan-klang-keun",hebrew:"לילה",english:"night",tone:'not_drilled',source:"תומר4,csv.txt"},
  {id:"uv19_0131",level:3,thai:"กินข้าว",roman:"gin-kaaw",hebrew:"לאכול (אורז/ארוחה)",english:"eat / have a meal",tone:'not_drilled',source:"תומר4,csv.txt"},
  {id:"uv19_0132",level:1,thai:"หนึ่ง",roman:"nueng",hebrew:"אחד",english:"one",tone:'not_drilled',source:"תומר4,csv.txt"},
  {id:"uv19_0133",level:1,thai:"สอง",roman:"song",hebrew:"שתיים",english:"two",tone:'not_drilled',source:"תומר4,csv.txt"},
  {id:"uv19_0134",level:1,thai:"สาม",roman:"saam",hebrew:"שלוש",english:"three",tone:'not_drilled',source:"תומר4,csv.txt"},
  {id:"uv19_0135",level:1,thai:"สี่",roman:"sii",hebrew:"ארבע",english:"four",tone:'not_drilled',source:"תומר4,csv.txt"},
  {id:"uv19_0136",level:1,thai:"ห้า",roman:"haa",hebrew:"חמש",english:"five",tone:'not_drilled',source:"תומר4,csv.txt"},
  {id:"uv19_0137",level:1,thai:"หก",roman:"hok",hebrew:"שש",english:"six",tone:'not_drilled',source:"תומר4,csv.txt"},
  {id:"uv19_0138",level:1,thai:"เจ็ด",roman:"jet",hebrew:"שבע",english:"seven",tone:'not_drilled',source:"תומר4,csv.txt"},
  {id:"uv19_0139",level:1,thai:"แปด",roman:"bpaed",hebrew:"שמונה",english:"eight",tone:'not_drilled',source:"תומר4,csv.txt"},
  {id:"uv19_0140",level:1,thai:"เก้า",roman:"gao",hebrew:"תשע",english:"nine",tone:'not_drilled',source:"תומר4,csv.txt"},
  {id:"uv19_0141",level:1,thai:"สิบ",roman:"sip",hebrew:"עשר",english:"ten",tone:'not_drilled',source:"תומר4,csv.txt"},
  {id:"uv19_0142",level:3,thai:"สิบเอ็ด",roman:"sip-et",hebrew:"אחת עשרה",english:"eleven",tone:'not_drilled',source:"תומר4,csv.txt"},
  {id:"uv19_0143",level:3,thai:"ยี่สิบ",roman:"yii-sip",hebrew:"עשרים",english:"twenty",tone:'not_drilled',source:"תומר4,csv.txt"},
  {id:"uv19_0144",level:1,thai:"ร้อย",roman:"roi",hebrew:"מאה",english:"hundred",tone:'not_drilled',source:"תומר4,csv.txt"},
  {id:"uv19_0145",level:1,thai:"พัน",roman:"pan",hebrew:"אלף",english:"thousand",tone:'not_drilled',source:"תומר4,csv.txt"},
  {id:"uv19_0146",level:1,thai:"หมื่น",roman:"meun",hebrew:"עשרת אלפים",english:"ten thousand",tone:'not_drilled',source:"תומר4,csv.txt"},
  {id:"uv19_0147",level:1,thai:"แสน",roman:"san",hebrew:"מאה אלף",english:"hundred thousand",tone:'not_drilled',source:"תומר4,csv.txt"},
  {id:"uv19_0148",level:1,thai:"ล้าน",roman:"lan",hebrew:"מיליון",english:"million",tone:'not_drilled',source:"תומר4,csv.txt"},
  {id:"uv19_0149",level:1,thai:"หน้า",roman:"naa",hebrew:"פנים / עונה / דף",english:"face / season / page",tone:'not_drilled',source:"תומר4,csv.txt"},
  {id:"uv19_0150",level:3,thai:"หน้าร้อน",roman:"naa-rawn",hebrew:"העונה החמה",english:"hot season",tone:'not_drilled',source:"תומר4,csv.txt"},
  {id:"uv19_0151",level:3,thai:"หน้าฝน",roman:"naa-fon",hebrew:"עונת הגשמים",english:"rainy season",tone:'not_drilled',source:"תומר4,csv.txt"},
  {id:"uv19_0152",level:3,thai:"หน้าหนาว",roman:"naa-nao",hebrew:"העונה הקרה",english:"cold season",tone:'not_drilled',source:"תומר4,csv.txt"},
  {id:"uv19_0153",level:1,thai:"ใกล้",roman:"glai",hebrew:"קרוב (טון נמוך)",english:"near",tone:'not_drilled',source:"תומר4,csv.txt"},
  {id:"uv19_0154",level:1,thai:"ไกล",roman:"glai",hebrew:"רחוק (טון גבוה)",english:"far",tone:'not_drilled',source:"תומר4,csv.txt"},
  {id:"uv19_0155",level:1,thai:"ต้อง",roman:"dtong",hebrew:"חייב",english:"must",tone:'not_drilled',source:"תומר4,csv.txt"},
  {id:"uv19_0156",level:1,thai:"กลัว",roman:"glua",hebrew:"לפחד",english:"afraid",tone:'not_drilled',source:"תומר4,csv.txt"},
  {id:"uv19_0157",level:3,thai:"ประมาณ",roman:"bpra-maan",hebrew:"בערך",english:"about / approximately",tone:'not_drilled',source:"תומר4,csv.txt"},
  {id:"uv19_0158",level:1,thai:"กลับ",roman:"glap",hebrew:"לחזור",english:"return",tone:'not_drilled',source:"תומר4,csv.txt"},
  {id:"uv19_0159",level:3,thai:"กลับบ้าน",roman:"glap baan",hebrew:"לחזור הביתה",english:"return home",tone:'not_drilled',source:"תומר4,csv.txt"},
  {id:"uv19_0160",level:1,thai:"เหงื่อ",roman:"heua",hebrew:"זיעה",english:"sweat",tone:'not_drilled',source:"תומר 5,csv.txt"},
  {id:"uv19_0161",level:3,thai:"เหงื่อออก",roman:"heua-awk",hebrew:"להזיע",english:"sweat / perspire",tone:'not_drilled',source:"תומר 5,csv.txt"},
  {id:"uv19_0162",level:1,thai:"เหนื่อย",roman:"nuay",hebrew:"עייף",english:"tired",tone:'not_drilled',source:"תומר 5,csv.txt"},
  {id:"uv19_0163",level:1,thai:"หิว",roman:"hiu",hebrew:"רעב",english:"hungry",tone:'not_drilled',source:"תומר 5,csv.txt"},
  {id:"uv19_0164",level:3,thai:"หิวน้ำ",roman:"hiu-nam",hebrew:"צמא",english:"thirsty",tone:'not_drilled',source:"תומר 5,csv.txt"},
  {id:"uv19_0165",level:1,thai:"อิ่ม",roman:"im",hebrew:"שבע (מאוכל)",english:"full from food",tone:'not_drilled',source:"תומר 5,csv.txt"},
  {id:"uv19_0166",level:1,thai:"เผ็ด",roman:"pet",hebrew:"חריף",english:"spicy",tone:'not_drilled',source:"תומר 5,csv.txt"},
  {id:"uv19_0167",level:1,thai:"เค็ม",roman:"kem",hebrew:"מלוח",english:"salty",tone:'not_drilled',source:"תומר 5,csv.txt"},
  {id:"uv19_0168",level:1,thai:"เปรี้ยว",roman:"bpreaw",hebrew:"חמוץ",english:"sour",tone:'not_drilled',source:"תומר 5,csv.txt"},
  {id:"uv19_0169",level:1,thai:"ขม",roman:"kom",hebrew:"מר",english:"bitter",tone:'not_drilled',source:"תומר 5,csv.txt"},
  {id:"uv19_0170",level:1,thai:"มัน",roman:"man",hebrew:"שומני",english:"oily / fatty",tone:'not_drilled',source:"תומר 5,csv.txt"},
  {id:"uv19_0171",level:1,thai:"จืด",roman:"juad",hebrew:"תפל",english:"bland",tone:'not_drilled',source:"תומר 5,csv.txt"},
  {id:"uv19_0172",level:3,thai:"ขยะ",roman:"ka-ya",hebrew:"זבל",english:"trash",tone:'not_drilled',source:"תומר 5,csv.txt"},
  {id:"uv19_0173",level:4,thai:"ไม่เป็นไร",roman:"mai-pen-rai",hebrew:"לא משנה / אין בעיה",english:"never mind / no problem",tone:'not_drilled',source:"תומר 5,csv.txt"},
  {id:"uv19_0174",level:3,thai:"โชคดี",roman:"chok-dee",hebrew:"בהצלחה",english:"good luck",tone:'not_drilled',source:"תומר 5,csv.txt"},
  {id:"uv19_0175",level:3,thai:"ลาก่อน",roman:"la-gon",hebrew:"להתראות",english:"goodbye",tone:'not_drilled',source:"תומר 5,csv.txt"},
  {id:"uv19_0176",level:4,thai:"ไปก่อนนะ",roman:"pai-gon-na",hebrew:"אני הולך עכשיו (להתראות)",english:"I am going now / bye",tone:'not_drilled',source:"תומר 5,csv.txt"},
  {id:"uv19_0177",level:3,thai:"ไปแล้ว",roman:"bpai-leaw",hebrew:"כבר הלכתי / הלכתי",english:"already went",tone:'not_drilled',source:"תומר 5,csv.txt"},
  {id:"uv19_0178",level:3,thai:"เจอกัน",roman:"jer-gan",hebrew:"נתראה",english:"see you",tone:'not_drilled',source:"תומר 5,csv.txt"},
  {id:"uv19_0179",level:3,thai:"ทุกวัน",roman:"tuk-wan",hebrew:"כל יום",english:"every day",tone:'not_drilled',source:"תומר 5,csv.txt"},
  {id:"uv19_0180",level:3,thai:"ทุกอย่าง",roman:"tuk-yaang",hebrew:"הכל",english:"everything",tone:'not_drilled',source:"תומר 5,csv.txt"},
  {id:"uv19_0181",level:3,thai:"บางที",roman:"bang-ti",hebrew:"לפעמים",english:"sometimes",tone:'not_drilled',source:"תומר 5,csv.txt"},
  {id:"uv19_0182",level:3,thai:"บางคน",roman:"bang-kon",hebrew:"חלק מהאנשים",english:"some people",tone:'not_drilled',source:"תומר 5,csv.txt"},
  {id:"uv19_0183",level:3,thai:"ไม่เคย",roman:"mai-koey",hebrew:"אף פעם לא",english:"never",tone:'not_drilled',source:"תומר 5,csv.txt"},
  {id:"uv19_0184",level:1,thai:"เคย",roman:"koey",hebrew:"פעם / כבר עשיתי",english:"ever",tone:'not_drilled',source:"תומר 5,csv.txt"},
  {id:"uv19_0185",level:1,thai:"เบื่อ",roman:"bua",hebrew:"משעמם",english:"bored",tone:'not_drilled',source:"תומר 5,csv.txt"},
  {id:"uv19_0186",level:3,thai:"ง่วงนอน",roman:"nguang-non",hebrew:"ישנוני",english:"sleepy",tone:'not_drilled',source:"תומר 5,csv.txt"},
  {id:"uv19_0187",level:1,thai:"สนุก",roman:"sanook",hebrew:"כיף",english:"fun",tone:'not_drilled',source:"תומר 5,csv.txt"},
  {id:"uv19_0188",level:1,thai:"เป็น",roman:"bpen",hebrew:"להיות / לדעת לעשות",english:"be / know how to",tone:'not_drilled',source:"תומר 5,csv.txt"},
  {id:"uv19_0189",level:1,thai:"คือ",roman:"kue",hebrew:"זה / הוא (להגדרות)",english:"is / means",tone:'not_drilled',source:"תומר 5,csv.txt"},
  {id:"uv19_0190",level:4,thai:"สวัสดี",roman:"sa-waat-dee",hebrew:"שלום",english:"hello",tone:'not_drilled',source:"תומר 5,csv.txt"},
  {id:"uv19_0191",level:3,thai:"ขอบคุณ",roman:"kob-kun",hebrew:"תודה",english:"thank you",tone:'not_drilled',source:"תומר 5,csv.txt"},
  {id:"uv19_0192",level:5,thai:"ยินดีที่ได้รู้จัก",roman:"yin-dee tii dai ruu-jak",hebrew:"נעים להכיר",english:"nice to meet you",tone:'not_drilled',source:"תומר 5,csv.txt"},
  {id:"uv19_0193",level:5,thai:"ที่ไหน",roman:"tii-nai?",hebrew:"איפה?",english:"where?",tone:'not_drilled',source:"תומר 5,csv.txt"},
  {id:"uv19_0194",level:5,thai:"เมื่อไร",roman:"meua-rai?",hebrew:"מתי?",english:"when?",tone:'not_drilled',source:"תומר 5,csv.txt"},
  {id:"uv19_0195",level:5,thai:"ยังไง",roman:"yang-ngai?",hebrew:"איך?",english:"how?",tone:'not_drilled',source:"תומר 5,csv.txt"},
  {id:"uv19_0196",level:3,thai:"เพราะว่า",roman:"prow-wa",hebrew:"בגלל ש...",english:"because",tone:'not_drilled',source:"תומר 5,csv.txt"},
  {id:"uv19_0197",level:4,thai:"ขนมปัง",roman:"ka-nom-bpang",hebrew:"לחם",english:"bread",tone:'not_drilled',source:"תומר 5,csv.txt"},
  {id:"uv19_0198",level:3,thai:"เนื้อ",roman:"neu-a",hebrew:"בשר / בקר",english:"meat / beef",tone:'not_drilled',source:"תומר 5,csv.txt"},
  {id:"uv19_0199",level:1,thai:"ไก่",roman:"gai",hebrew:"עוף",english:"chicken",tone:'not_drilled',source:"תומר 6,csv.txt"},
  {id:"uv19_0200",level:1,thai:"หมู",roman:"moo",hebrew:"חזיר",english:"pork / pig",tone:'not_drilled',source:"תומר 6,csv.txt"},
  {id:"uv19_0201",level:1,thai:"ปลา",roman:"bpaa",hebrew:"דג",english:"fish",tone:'not_drilled',source:"תומר 6,csv.txt"},
  {id:"uv19_0202",level:1,thai:"กุ้ง",roman:"goong",hebrew:"שרימפס",english:"shrimp",tone:'not_drilled',source:"תומר 6,csv.txt"},
  {id:"uv19_0203",level:1,thai:"ปู",roman:"puu",hebrew:"סרטן",english:"crab",tone:'not_drilled',source:"תומר 6,csv.txt"},
  {id:"uv19_0204",level:1,thai:"ไข่",roman:"kai",hebrew:"ביצה",english:"egg",tone:'not_drilled',source:"תומר 6,csv.txt"},
  {id:"uv19_0205",level:3,thai:"ไข่ดาว",roman:"kai-dao",hebrew:"ביצת עין",english:"fried egg",tone:'not_drilled',source:"תומר 6,csv.txt"},
  {id:"uv19_0206",level:3,thai:"ไข่เจียว",roman:"kai-jeaw",hebrew:"חביתה",english:"omelette",tone:'not_drilled',source:"תומר 6,csv.txt"},
  {id:"uv19_0207",level:1,thai:"ผัก",roman:"pak",hebrew:"ירקות",english:"vegetables",tone:'not_drilled',source:"תומר 6,csv.txt"},
  {id:"uv19_0208",level:4,thai:"ผลไม้",roman:"pon-la-mai",hebrew:"פירות",english:"fruit",tone:'not_drilled',source:"תומר 6,csv.txt"},
  {id:"uv19_0209",level:1,thai:"ส้ม",roman:"som",hebrew:"תפוז",english:"orange",tone:'not_drilled',source:"תומר 6,csv.txt"},
  {id:"uv19_0210",level:3,thai:"มะม่วง",roman:"ma-muang",hebrew:"מנגו",english:"mango",tone:'not_drilled',source:"תומר 6,csv.txt"},
  ...
  {id:"uv19_0218",level:1,thai:"นม",roman:"nom",hebrew:"חלב",english:"milk",tone:'not_drilled',source:"תומר 6,csv.txt"},
  {id:"uv19_0219",level:1,thai:"เบียร์",roman:"beer",hebrew:"בירה",english:"beer",tone:'not_drilled',source:"תומר 6,csv.txt"},
  {id:"uv19_0220",level:1,thai:"เหล้า",roman:"lao",hebrew:"אלכוהול / וויסקי",english:"alcohol / whiskey",tone:'not_drilled',source:"תומר 6,csv.txt"},
  {id:"uv19_0221",level:1,thai:"กับ",roman:"gap",hebrew:"עם",english:"with",tone:'not_drilled',source:"תומר 6,csv.txt"},
  {id:"uv19_0222",level:1,thai:"เอา",roman:"ao",hebrew:"רוצה / לקחת",english:"want / take",tone:'not_drilled',source:"תומר 6,csv.txt"},
  {id:"uv19_0223",level:3,thai:"ไม่เอา",roman:"mai ao",hebrew:"לא רוצה",english:"do not want",tone:'not_drilled',source:"תומר 6,csv.txt"},
  {id:"uv19_0224",level:4,thai:"เอาอันนี้",roman:"ao-an-nii",hebrew:"רוצה את זה",english:"want this one",tone:'not_drilled',source:"תומר 6,csv.txt"},
  {id:"uv19_0225",level:1,thai:"เรือ",roman:"reua",hebrew:"סירה",english:"boat",tone:'not_drilled',source:"תומר 6,csv.txt"},
  {id:"uv19_0226",level:3,thai:"เรือบิน",roman:"reua-bin",hebrew:"מטוס",english:"airplane",tone:'not_drilled',source:"תומר 6,csv.txt"},
  {id:"uv19_0227",level:1,thai:"รถ",roman:"rot",hebrew:"מכונית",english:"car / vehicle",tone:'not_drilled',source:"תומר 6,csv.txt"},
  {id:"uv19_0228",level:3,thai:"รถเมล์",roman:"rot-mae",hebrew:"אוטובוס",english:"bus",tone:'not_drilled',source:"תומר 6,csv.txt"},
  {id:"uv19_0229",level:3,thai:"รถไฟ",roman:"rot-fai",hebrew:"רכבת",english:"train",tone:'not_drilled',source:"תומר 6,csv.txt"},
  {id:"uv19_0230",level:4,thai:"มอเตอร์ไซค์",roman:"mo-dtu-sai",hebrew:"אופנוע",english:"motorbike",tone:'not_drilled',source:"תומר 6,csv.txt"},
  {id:"uv19_0231",level:4,thai:"จักรยาน",roman:"jak-kra-yaan",hebrew:"אופניים",english:"bicycle",tone:'not_drilled',source:"תומר 6,csv.txt"},
  {id:"uv19_0232",level:1,thai:"เดิน",roman:"doen",hebrew:"ללכת ברגל",english:"walk",tone:'not_drilled',source:"תומר 6,csv.txt"},
  {id:"uv19_0233",level:1,thai:"วิ่ง",roman:"wing",hebrew:"לרוץ",english:"run",tone:'not_drilled',source:"תומר 6,csv.txt"},
  {id:"uv19_0234",level:1,thai:"สวย",roman:"suay",hebrew:"יפה",english:"beautiful",tone:'not_drilled',source:"תומר 6,csv.txt"},
  {id:"uv19_0235",level:3,thai:"น่ารัก",roman:"naa-rak",hebrew:"חמוד",english:"cute",tone:'not_drilled',source:"תומר 6,csv.txt"},
  {id:"uv19_0236",level:1,thai:"หล่อ",roman:"lor",hebrew:"חתיך",english:"handsome",tone:'not_drilled',source:"תומר 6,csv.txt"},
  {id:"uv19_0237",level:1,thai:"เตี้ย",roman:"dtia",hebrew:"נמוך",english:"short",tone:'not_drilled',source:"תומר 6,csv.txt"},
  {id:"uv19_0238",level:1,thai:"สูง",roman:"soong",hebrew:"גבוה",english:"tall",tone:'not_drilled',source:"תומר 6,csv.txt"},
  {id:"uv19_0239",level:3,thai:"อ้วน",roman:"u-an",hebrew:"שמן (גוף)",english:"fat / overweight",tone:'not_drilled',source:"תומר 7,csv.txt"},
  {id:"uv19_0240",level:1,thai:"ผอม",roman:"pom",hebrew:"רזה",english:"thin",tone:'not_drilled',source:"תומר 7,csv.txt"},
  {id:"uv19_0241",level:1,thai:"ใหญ่",roman:"yai",hebrew:"גדול",english:"big",tone:'not_drilled',source:"תומר 7,csv.txt"},
  {id:"uv19_0242",level:1,thai:"เล็ก",roman:"lek",hebrew:"קטן",english:"small",tone:'not_drilled',source:"תומר 7,csv.txt"},
  {id:"uv19_0243",level:1,thai:"เหงา",roman:"ngao",hebrew:"בודד",english:"lonely",tone:'not_drilled',source:"תומר 7,csv.txt"},
  {id:"uv19_0244",level:3,thai:"เสียใจ",roman:"sia-jai",hebrew:"עצוב",english:"sad / sorry",tone:'not_drilled',source:"תומר 7,csv.txt"},
  {id:"uv19_0245",level:3,thai:"ดีใจ",roman:"dii-jai",hebrew:"שמח",english:"happy",tone:'not_drilled',source:"תומר 7,csv.txt"},
  {id:"uv19_0246",level:1,thai:"โกรธ",roman:"grote",hebrew:"כועס",english:"angry",tone:'not_drilled',source:"תומר 7,csv.txt"},
  {id:"uv19_0247",level:1,thai:"กลัว",roman:"glua",hebrew:"מפחד",english:"afraid",tone:'not_drilled',source:"תומר 7,csv.txt"},
  {id:"uv19_0248",level:3,thai:"ตกใจ",roman:"dtok-jai",hebrew:"מופתע / בהלם",english:"shocked / startled",tone:'not_drilled',source:"תומר 7,csv.txt"},
  {id:"uv19_0249",level:1,thai:"งง",roman:"ngong",hebrew:"מבולבל",english:"confused",tone:'not_drilled',source:"תומר 7,csv.txt"},
  {id:"uv19_0250",level:3,thai:"มั่นใจ",roman:"man-jai",hebrew:"בטוח בעצמי",english:"confident",tone:'not_drilled',source:"תומר 7,csv.txt"},
  {id:"uv19_0251",level:4,thai:"น่าเข้าใจ",roman:"naa-kao-jai",hebrew:"מובן",english:"understandable",tone:'not_drilled',source:"תומר 7,csv.txt"},
  {id:"uv19_0252",level:4,thai:"ไม่เข้าใจ",roman:"mai-kao-jai",hebrew:"לא מבין",english:"do not understand",tone:'not_drilled',source:"תומר 7,csv.txt"},
  {id:"uv19_0253",level:5,thai:"เข้าใจไหม",roman:"kao-jai mai?",hebrew:"מבין?",english:"Do you understand?",tone:'not_drilled',source:"תומר 7,csv.txt"},
  {id:"uv19_0254",level:4,thai:"เข้าใจแล้ว",roman:"kao-jai leaw",hebrew:"הבנתי כבר",english:"understood already",tone:'not_drilled',source:"תומר 7,csv.txt"},
  {id:"uv19_0255",level:1,thai:"รัก",roman:"rak",hebrew:"אוהב",english:"love",tone:'not_drilled',source:"תומר 7,csv.txt"},
  {id:"uv19_0256",level:1,thai:"เกลียด",roman:"gliad",hebrew:"שונא",english:"hate",tone:'not_drilled',source:"תומר 7,csv.txt"},
  {id:"uv19_0257",level:3,thai:"เห็นด้วย",roman:"hen-duai",hebrew:"מסכים",english:"agree",tone:'not_drilled',source:"תומר 7,csv.txt"},
  {id:"uv19_0258",level:4,thai:"ไม่เห็นด้วย",roman:"mai-hen-duai",hebrew:"לא מסכים",english:"disagree",tone:'not_drilled',source:"תומר 7,csv.txt"},
  {id:"uv19_0259",level:3,thai:"จริง ๆ",roman:"jing-jing",hebrew:"באמת",english:"really",tone:'not_drilled',source:"תומר 7,csv.txt"},
  {id:"uv19_0260",level:1,thai:"ลอง",roman:"long",hebrew:"לנסות",english:"try",tone:'not_drilled',source:"תומר 7,csv.txt"},
  {id:"uv19_0261",level:1,thai:"ดู",roman:"duu",hebrew:"לראות / להסתכל",english:"look / watch",tone:'not_drilled',source:"תומר 7,csv.txt"},
  {id:"uv19_0262",level:1,thai:"ฟัง",roman:"fang",hebrew:"להקשיב",english:"listen",tone:'not_drilled',source:"תומר 7,csv.txt"},
  {id:"uv19_0263",level:1,thai:"ดม",roman:"dom",hebrew:"להריח",english:"smell",tone:'not_drilled',source:"תומר 7,csv.txt"},
  {id:"uv19_0264",level:1,thai:"ชิม",roman:"chim",hebrew:"לטעום",english:"taste",tone:'not_drilled',source:"תומר 7,csv.txt"},
  {id:"uv19_0265",level:1,thai:"จำ",roman:"jum",hebrew:"לזכור",english:"remember",tone:'not_drilled',source:"תומר 7,csv.txt"},
  {id:"uv19_0266",level:1,thai:"เคย",roman:"keey",hebrew:"להתרגל / פעם...",english:"ever / used to",tone:'not_drilled',source:"תומר 7,csv.txt"},
  {id:"uv19_0267",level:1,thai:"เที่ยว",roman:"teaw",hebrew:"לטייל / לבלות",english:"travel / hang out",tone:'not_drilled',source:"תומר 7,csv.txt"},
  {id:"uv19_0268",level:1,thai:"รอ",roman:"raw",hebrew:"לחכות",english:"wait",tone:'not_drilled',source:"תומר 7,csv.txt"},
  {id:"uv19_0269",level:1,thai:"ซื้อ",roman:"suu",hebrew:"לקנות",english:"buy",tone:'not_drilled',source:"תומר 7,csv.txt"},
  {id:"uv19_0270",level:1,thai:"ขาย",roman:"kaai",hebrew:"למכור",english:"sell",tone:'not_drilled',source:"תומר 7,csv.txt"},
  {id:"uv19_0271",level:1,thai:"ให้",roman:"hai",hebrew:"לתת / עבור",english:"give / for",tone:'not_drilled',source:"תומר 7,csv.txt"},
  {id:"uv19_0272",level:3,thai:"ช่วย",roman:"choo-ay",hebrew:"לעזור",english:"help",tone:'not_drilled',source:"תומר 7,csv.txt"},
  ...
  {id:"uv19_0343",level:3,thai:"ตอนเที่ยง",roman:"dton-tiang",hebrew:"בצהריים",english:"noon / midday",tone:'not_drilled',source:"אלמוג 5(2).apkg"},
  {id:"uv19_0344",level:3,thai:"ตอนบ่าย",roman:"dton-baai",hebrew:"אחר הצהריים",english:"afternoon",tone:'not_drilled',source:"אלמוג 5(2).apkg"},
  {id:"uv19_0345",level:3,thai:"ตอนเย็น",roman:"dton-yen",hebrew:"בערב",english:"evening",tone:'not_drilled',source:"אלמוג 5(2).apkg"},
  {id:"uv19_0346",level:4,thai:"ตอนกลางคืน",roman:"dton-glaang-kheun",hebrew:"בלילה",english:"night / at night",tone:'not_drilled',source:"אלמוג 5(2).apkg"},
  {id:"uv19_0347",level:4,thai:"ตอนดึก",roman:"dton-deuk",hebrew:"מאוחר בלילה",english:"late at night",tone:'not_drilled',source:"אלמוג 5(2).apkg"},
  {id:"uv19_0348",level:3,thai:"เห็นด้วย",roman:"hen-duai",hebrew:"להסכים",english:"agree",tone:'not_drilled',source:"אלמוג 5(2).apkg"},
  {id:"uv19_0349",level:5,thai:"เห็นไหม",roman:"hen mai?",hebrew:"רואה?",english:"Do you see?",tone:'not_drilled',source:"אלמוג 5(2).apkg"},
  {id:"uv19_0350",level:5,thai:"เห็นด้วยไหม",roman:"hen-duai mai?",hebrew:"האם אתה מסכים?",english:"Do you agree?",tone:'not_drilled',source:"אלמוג 5(2).apkg"},
  {id:"uv19_0351",level:1,thai:"ยืน",roman:"yuen",hebrew:"לעמוד",english:"stand",tone:'not_drilled',source:"אלמוג 5(2).apkg"},
  {id:"uv19_0352",level:1,thai:"นั่ง",roman:"nang",hebrew:"לשבת",english:"sit",tone:'not_drilled',source:"אלמוג 5(2).apkg"},
  {id:"uv19_0353",level:1,thai:"เดิน",roman:"dern",hebrew:"ללכת",english:"walk",tone:'not_drilled',source:"אלמוג 5(2).apkg"},
  {id:"uv19_0354",level:1,thai:"ข้าม",roman:"khaam",hebrew:"לדלג",english:"cross / skip over",tone:'not_drilled',source:"אלמוג 5(2).apkg"},
  {id:"uv19_0355",level:4,thai:"ไม่ไหว",roman:"mai wai",hebrew:"לא יכול / לא מסוגל / לא עומד בזה",english:"cannot handle it / cannot manage",tone:'not_drilled',source:"אלמוג 5(2).apkg"},
  {id:"uv19_0356",level:4,thai:"ไม่ต้องห่วง",roman:"mai dtong huang",hebrew:"אל תדאג / אין מה לדאוג",english:"do not worry",tone:'not_drilled',source:"אלמוג 5(2).apkg"},
  {id:"uv19_0357",level:4,thai:"ไม่สนใจ",roman:"mai son jai",hebrew:"לא מעוניין / לא אכפת",english:"not interested / do not care",tone:'not_drilled',source:"אלמוג 5(2).apkg"},
  {id:"uv19_0358",level:4,thai:"ไม่มีอะไร",roman:"mai mee a-rai",hebrew:"אין כלום",english:"there is nothing / nothing",tone:'not_drilled',source:"אלמוג 5(2).apkg"},
  {id:"uv19_0359",level:3,thai:"ไม่ต้อง",roman:"mai dtong",hebrew:"לא צריך / אין צורך",english:"do not need",tone:'not_drilled',source:"אלמוג 5(2).apkg"},
  {id:"uv19_0360",level:4,thai:"ไม่มีปัญหา",roman:"mai mee pan-haa",hebrew:"אין בעיה",english:"no problem",tone:'not_drilled',source:"אלמוג 5(2).apkg"},
  {id:"uv19_0361",level:4,thai:"ไม่มีทาง",roman:"mâi mee taang",hebrew:"אין מצב / אין סיכוי",english:"no way",tone:'not_drilled',source:"אלמוג 5(2).apkg"},
  {id:"uv19_0362",level:5,thai:"ว่าไง",roman:"wâa ngai",hebrew:"מה קורה? / מה נשמע?",english:"what’s up?",tone:'not_drilled',source:"אלמוג 5(2).apkg"},
  {id:"uv19_0363",level:4,thai:"ไม่เก็ทอะ",roman:"mâi get à",hebrew:"אני לא מבין / לא קולט",english:"I do not get it",tone:'not_drilled',source:"אלמוג 5(2).apkg"},
  {id:"uv19_0364",level:5,thai:"แล้วไง",roman:"láew ngai",hebrew:"אז מה?",english:"so what?",tone:'not_drilled',source:"אלמוג 5(2).apkg"},
  {id:"uv19_0365",level:3,thai:"คิดว่า",roman:"khít wâa",hebrew:"לחשוב ש...",english:"think that",tone:'not_drilled',source:"אלמוג 5(2).apkg"},
  {id:"uv19_0366",level:3,thai:"พูดว่า",roman:"phuut waa",hebrew:"לומר ש...",english:"say that...",tone:'not_drilled',source:"אלמוג 5(2).apkg"},
  {id:"uv19_0367",level:3,thai:"บอกว่า",roman:"bòk wâa",hebrew:"לספר / להגיד ש...",english:"tell / say that",tone:'not_drilled',source:"אלמוג 5(2).apkg"},
  {id:"uv19_0368",level:4,thai:"รู้สึกว่า",roman:"rúu sèuk wâa",hebrew:"להרגיש ש...",english:"feel that",tone:'not_drilled',source:"אלמוג 5(2).apkg"},
  {id:"uv19_0369",level:3,thai:"เพราะว่า",roman:"phróh wâa",hebrew:"בגלל ש...",english:"because",tone:'not_drilled',source:"אלמוג 5(2).apkg"},
  {id:"uv19_0370",level:4,thai:"ได้ยินว่า",roman:"dai-yin waa",hebrew:"לשמוע ש...",english:"hear that...",tone:'not_drilled',source:"אלמוג 5(2).apkg"},
  {id:"uv19_0371",level:3,thai:"ต้นไม้",roman:"ton mai",hebrew:"צמח / עץ",english:"plant / tree",tone:'not_drilled',source:"אלמוג 4(1).apkg"},
  {id:"uv19_0372",level:1,thai:"บาง",roman:"baang",hebrew:"חלק מ..",english:"some / part of",tone:'not_drilled',source:"אלמוג 4(1).apkg"},
  {id:"uv19_0373",level:3,thai:"ด้วยกัน",roman:"duay gan",hebrew:"יחדיו",english:"together",tone:'not_drilled',source:"אלמוג 4(1).apkg"},
  {id:"uv19_0374",level:3,thai:"บางที",roman:"baang tii",hebrew:"יכול להיות",english:"maybe / sometimes",tone:'not_drilled',source:"אלמוג 4(1).apkg"},
  {id:"uv19_0375",level:3,thai:"พวกเขา",roman:"phuak khao",hebrew:"הם",english:"they / them",tone:'not_drilled',source:"אלמוג 4(1).apkg"},
  {id:"uv19_0376",level:3,thai:"บางวัน",roman:"baang wan",hebrew:"חלק מהימים",english:"some days",tone:'not_drilled',source:"אלמוג 4(1).apkg"},
  {id:"uv19_0377",level:3,thai:"ทุกที่",roman:"tug tii",hebrew:"בכל מקום",english:"everywhere",tone:'not_drilled',source:"אלמוג 4(1).apkg"},
  {id:"uv19_0378",level:1,thai:"ออก",roman:"awk",hebrew:"יציאה,החוצה",english:"exit / out / go out",tone:'not_drilled',source:"אלמוג 4(1).apkg"},
  {id:"uv19_0379",level:1,thai:"อุ่น",roman:"un",hebrew:"חמים,חם",english:"warm",tone:'not_drilled',source:"אלמוג 4(1).apkg"},
  {id:"uv19_0380",level:5,thai:"ตอนผมเด็ก ๆ",roman:"dton phom dek dek",hebrew:"כשהייתי ילד",english:"when I was a child",tone:'not_drilled',source:"אלמוג 4(1).apkg"},
  {id:"uv19_0381",level:1,thai:"เข้า",roman:"khao",hebrew:"להיכנס / כניסה",english:"enter / go in",tone:'not_drilled',source:"אלמוג 4(1).apkg"},
  {id:"uv19_0382",level:1,thai:"หน้า",roman:"naa",hebrew:"פנים / קדימה / עונה / דף",english:"face / front / season / page",tone:'not_drilled',source:"אלמוג 4(1).apkg"},
  {id:"uv19_0383",level:3,thai:"โรงพัก",roman:"rong pag",hebrew:"תחנת משטרה",english:"police station",tone:'not_drilled',source:"אלמוג 4(1).apkg"},
  {id:"uv19_0384",level:3,thai:"ไม่ได้…",roman:"mai dai+v",hebrew:"לא עשיתי",english:"did not / cannot + verb",tone:'not_drilled',source:"אלמוג 4(1).apkg"},
  {id:"uv19_0385",level:5,thai:"ดีใจที่ได้เจอ",roman:"dii-jai tii dai jer",hebrew:"נחמד לראותך",english:"nice to see you",tone:'not_drilled',source:"אלמוג 4(1).apkg"},
  {id:"uv19_0386",level:1,thai:"ผึ้ง",roman:"phueng",hebrew:"דבורה",english:"bee",tone:'not_drilled',source:"אלמוג 4(1).apkg"},
  {id:"uv19_0387",level:3,thai:"ต่อย",roman:"dtoy",hebrew:"אגרוף / לעקוץ",english:"to punch / to sting",tone:'not_drilled',source:"אלמוג 4(1).apkg"}
